                    ...
                    <div class="row footer-standard">
                        ...
                        <div class="widget text-left">			
                                <div class="textwidget">
                                    <p><small>© 2022 KULTURAQUI. Todos os direitos reservados. 
                        ...
                        <div class="widget text-left">
                                <div class="textwidget">
                                    <h6 class="footer-link-title">Brevemente</h6>
                                    <div class="d-flex align-items-center">
                                    <img class="mr-3" src="{{ asset('assets/frontend/images/footer/01.jpg') }}" alt="play-store">
                                    <img src="{{ asset('assets/frontend/images/footer/02.jpg') }}" alt="app-store">
                                    </div>
                                </div>
                        </div>
                        </div>
